...
namespace z
{
    ...
    class LabLSTMInferenceWorker : public CommonLocoInferenceWorker<SchedulerType, InferencePrecision, JOINT_NUMBER>
    {
    public:
    ...
    public:
        ...
        LabLSTMInferenceWorker(SchedulerType* scheduler, const nlohmann::json& Net_cfg, const nlohmann::json& Motor_cfg)
            ...
            HistoryInputBuffer(INPUT_STUCK_LENGTH)
        {
            ...
            this->PrintSplitLine();
            std::cout << "LabLSTMInferenceWorker" << std::endl;
         ...
         *
         */
        virtual ~LabLSTMInferenceWorker()
        {
        }
