...
namespace z
{
    ...
    class LeggedLabInferenceWorker : public CommonLocoInferenceWorker<SchedulerType, InferencePrecision, JOINT_NUMBER>
    {
    public:
    ...
    public:
         ...
         * @param cfg 配置文件
         */
        LeggedLabInferenceWorker(SchedulerType* scheduler, const nlohmann::json& cfg)
         ...
         *
         */
        virtual ~LeggedLabInferenceWorker()
        {
    ...
    private:
        ...
        static constexpr size_t INPUT_TENSOR_LENGTH_UNIT = 3 + JOINT_NUMBER + JOINT_NUMBER + JOINT_NUMBER + 3 + 3;
