...
namespace z
{
    ...
    class HumanLabRunInferenceWorker : public CommonLocoInferenceWorker<SchedulerType, InferencePrecision, JOINT_NUMBER>
    {
    public:
    ...
    public:HumanLabRunInferenceWorker(SchedulerType* scheduler, const nlohmann::json& Net_cfg, const nlohmann::json& Motor_cfg)
            ...
            HistoryInputBuffer(INPUT_STUCK_LENGTH)
        {
            ...
            auto clock_scales = math::Vector<InferencePrecision, 4>::ones();
         ...
         *
         */
        virtual ~HumanLabRunInferenceWorker()
        {
        ...
        void PreProcess() override
        {
            ...
            InferencePrecision phase2 = 2 * phase;
            InferencePrecision clock_sin = std::sin(phase * 2 * M_PI);
            InferencePrecision clock_cos = std::cos(phase * 2 * M_PI);
            InferencePrecision clock_sin2 = std::sin(phase2 * 2 * M_PI);
            InferencePrecision clock_cos2 = std::cos(phase2 * 2 * M_PI);
            z::math::Vector<InferencePrecision, 4> ClockVector = { clock_sin, clock_cos,clock_sin2,clock_cos2 };
    ...
    private:
        ...
        static constexpr size_t INPUT_TENSOR_LENGTH_UNIT = 3 + JOINT_NUMBER + JOINT_NUMBER + JOINT_NUMBER + 3 + 3 + 4;
