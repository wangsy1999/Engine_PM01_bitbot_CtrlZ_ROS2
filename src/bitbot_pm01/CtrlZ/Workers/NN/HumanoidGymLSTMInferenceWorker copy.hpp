...
namespace z
{
    ...
    class HumanoidGymLSTMInferenceWorker : public CommonLocoInferenceWorker<SchedulerType, InferencePrecision, JOINT_NUMBER>
    {
    public:
    ...
    public:
         ...
         * @param cfg 配置文件
         */
        HumanoidGymLSTMInferenceWorker(SchedulerType *scheduler, const nlohmann::json &cfg)
         ...
         *
         */
        virtual ~HumanoidGymLSTMInferenceWorker()
        {
        }
